...
namespace RTLTMPro
{
    public static class TextUtils
    {
        ...
        private const char LowerCaseG = (char)0x11F; // 'ğ'
        private const char UpperCaseG = (char)0x11E; // 'Ğ'
        private const char LowerCaseI = (char)0x131; // 'ı'
        private const char UpperCaseI = (char)0x130; // 'İ'
        private const char LowerCaseO = (char)0xF6; // 'ö'
        private const char UpperCaseO = (char)0xD6; // 'Ö'
        private const char LowerCaseS = (char)0x15F; // 'ş'
        private const char UpperCaseS = (char)0x15E; // 'Ş'
        private const char LowerCaseU = (char)0xFC; // 'ü'
        private const char UpperCaseU = (char)0xDC; // 'Ü'
        private const char LowerCaseC = (char)0xE7; // 'ç'
        private const char UpperCaseC = (char)0xC7; // 'Ç'
        ...
        public static bool IsLatinLetter(char ch)
        {
            ...
            return ch >= UpperCaseA && ch <= UpperCaseZ || ch >= LowerCaseA && ch <= LowerCaseZ ||
                   ch == LowerCaseG || ch == UpperCaseG || ch == LowerCaseI || ch == UpperCaseI ||
                   ch == LowerCaseO || ch == UpperCaseO || ch == LowerCaseS || ch == UpperCaseS ||
                   ch == LowerCaseU || ch == UpperCaseU || ch == LowerCaseC || ch == UpperCaseC;
        }
