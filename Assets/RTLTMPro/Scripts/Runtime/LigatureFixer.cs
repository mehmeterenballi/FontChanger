    ...
    public static class LigatureFixer
    {
        ...
        public static void Fix(FastStringBuilder input, FastStringBuilder output, bool farsi, bool fixTextTags, bool preserveNumbers)
        {
            ...
            for (int i = input.Length - 1; i >= 0; i--)
            {
                ...
                if (isInMiddle)
                {
                    bool isAfterEnglishChar = Char32Utils.IsLatinLetter(previousCharacter);
                    bool isBeforeEnglishChar = Char32Utils.IsLatinLetter(nextCharacter);
                ...
                if (Char32Utils.IsLatinLetter(characterAtThisIndex) ||
